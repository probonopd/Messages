...
@class MSGBubbleMessage;
@class MSGBubbleTheme;
@class MSGBubbleTranscriptView;

@protocol MSGBubbleTranscriptViewDelegate <NSObject>
@optional
...
@interface MSGBubbleTranscriptView : NSView

@property (nonatomic, retain) MSGBubbleTheme *theme;
@property (nonatomic, assign) id<MSGBubbleTranscriptViewDelegate> delegate;
