...
{
	id<MSGContextMenuActionDelegate> _actionDelegate;
}
- (instancetype)initWithDelegate:(id<MSGContextMenuActionDelegate>)delegate;
@end
...
@implementation MSGContextMenuBuilder
	...
	delegate:(id<MSGContextMenuActionDelegate>)delegate
{
	...
	if (channel.type == MSGChannelTypeLobby) {
	...
	delegate:(id<MSGContextMenuActionDelegate>)delegate
{
	...
	MSGUser *myUser = [channel userWithNick:myNick]
